...
describe("getExampleStep", () => {
  ...
  describe("Successful example download", () => {
    ...
    it("should handle different repositories", async () => {
      const customExample = {
        ...mockExample,
        repo: "CustomOrg/custom-examples",
      };
  ...
  describe("Error handling", () => {
    it("should handle download errors for default example", async () => {
      ...
      const configWithDefaultExample = {
        ...mockConfig,
      ...
      await expect(getExampleStep(configWithDefaultExample)).rejects.toThrow(
        "Download failed",
      );
    ...
    it("should handle CreateSkipServiceError instances", async () => {
      ...
      const customError = new CreateSkipServiceError(
  ...
  describe("Configuration edge cases", () => {
    ...
    it("should handle example with special characters in name", async () => {
      const specialExample = {
        ...mockExample,
        name: "example-with_special.chars-123",
      };
      const configWithSpecialExample = {
        ...mockConfig,
        example: specialExample,
      };
      const { logger } = await import("../io.js");
      const { downloadRepo } = await import("../downloadUtils.js");
    ...
    it("should handle long example names", async () => {
      const longExample = {
        ...mockExample,
        name: "very-long-example-name-with-many-hyphens-and-descriptive-text",
      };
